...
export CC=$HOME/llvm/gcc-4.8.2-install/bin/gcc
export CXX=$HOME/llvm/gcc-4.8.2-install/bin/g++
...
wget --continue http://www.netgull.com/gcc/releases/gcc-4.8.2/gcc-4.8.2.tar.bz2 &
